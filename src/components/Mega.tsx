...
export default function Mega() {
  const posts = [
    ...
    },
    {
      ...
      description:'Web development involves creating and maintaining websites. It includes designing the front end (what users see), developing the back end (server and database management), and ensuring websites are fast, secure, and user-friendly. Its the backbone of',
    ...
    },
    {
      ...
      description:'Cybersecurity is the practice of protecting computers, networks, and data from unauthorized access or attacks. It ensures digital safety by using tools and techniques like firewalls, encryption, and secure passwords, keeping personal and business information ',
    ...
    },
    {
      ...
      description:'Machine Learning is a branch of Artificial Intelligence where computers learn from data and improve their performance over time without being explicitly programmed. It powers applications like recommendation systems, image recognition, and predictive',
